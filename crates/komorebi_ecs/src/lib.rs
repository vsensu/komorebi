...
impl World {
    ...
    ///
    /// Returns `false` if the entity was previously destroyed
    ...
    ///
    /// Return `Some` if there was pre-existing component for this entity in this storage.
    ...
    ///
    /// Returns `None` if no such component exists.
